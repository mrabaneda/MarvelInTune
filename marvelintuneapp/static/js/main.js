...
document.addEventListener('DOMContentLoaded', function() {
  ...
  formulario.addEventListener('submit', function(event) {
    ...
    // -------------------- PRIMERA PETICION API: https://rapidapi.com/apidojo/api/shazam  ----------------------------------
    ...
    // ---------------------------------- PARTE DE LA SEGUNDA API ----------------------------------
        ...
        // -------------------- SEGUNDA PETICION API: https://rapidapi.com/apidojo/api/online-movie-database/ ----------------------------------
